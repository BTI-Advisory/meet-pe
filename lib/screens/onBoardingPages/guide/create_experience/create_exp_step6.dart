...
class _CreateExpStep6State extends State<CreateExpStep6> {
  ...
  void initState() {
    super.initState();
    // Remove the first element from the imageArray if it's not empty
    if (widget.imageArray.isNotEmpty) {
      widget.imageArray.removeAt(0);
    }
  }
              ...
              children: [
                ...
                /*Container(
                    ...
                    decoration: ShapeDecoration(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(
                            ResponsiveSize.calculateCornerRadius(45, context)),
                      ),
                    ),
                    child: Column()),*/
