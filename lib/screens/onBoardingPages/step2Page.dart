...
class _Step2PageState extends State<Step2Page> {
  ...
  Set<int> selectedIdsStep2 = Set<int>();
                ...
                child: Wrap(
                  ...
                  children: myList.map((item) {
                    return Item(
                      id: item.id,
                      text: item.title,
                      isSelected: selectedIdsStep2.contains(item.id),
                      onTap: () {
                        setState(() {
                          if (selectedIdsStep2.contains(item.id)) {
                            selectedIdsStep2.remove(item.id);
                          } else {
                            selectedIdsStep2.add(item.id);
                          }
                        });
                      },
                    );
