...
part 'user_travelers_response.g.dart';

@JsonSerializable(createToJson: false)
class UserTravelersResponse {
  ...
  factory UserTravelersResponse.fromJson(Map<String, dynamic> json) =>
      _$UserTravelersResponseFromJson(json);
}
