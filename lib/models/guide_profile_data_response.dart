...
part 'guide_profile_data_response.g.dart';

@JsonSerializable(createToJson: false)
class GuideProfileDataResponse {
  ...
  factory GuideProfileDataResponse.fromJson(Map<String, dynamic> json) =>
      _$GuideProfileDataResponseFromJson(json);
}
