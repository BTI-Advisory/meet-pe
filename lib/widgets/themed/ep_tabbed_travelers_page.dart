...
class EpTabbedTravelersPage extends StatefulWidget {
  ...
  final List<EpTabbedTravelersPageItem> pages;
  final StreamController<int> pageController;

  @override
  State<EpTabbedTravelersPage> createState() => _EpTabbedTravelersPageState();
}

class _EpTabbedTravelersPageState extends State<EpTabbedTravelersPage> {
  late int _index;
...
class EpTabbedTravelersPageItem extends _EpBottomNavigationBarItem {
  const EpTabbedTravelersPageItem(super.icon, this.page, [super.builder]);
